//! Note that unlike the others, this benchmark requires the nightly compiler to run.
...
fn main() {
    ...
    let result = find_nth_odd(std::hint::black_box::<&dyn OddFinder>(&finder), 1_000_000_000);
